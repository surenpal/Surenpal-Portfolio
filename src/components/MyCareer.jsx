            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Content */}
                  <p className="relative text-yellow-500 font-semibold mb-2 z-10">
                    {item.year}
                  </p>

                  <h3 className="relative text-xl font-semibold mb-3 z-10
                  group-hover:text-yellow-500 transition">
                    {item.title}
                  </h3>

                  <p className="relative text-gray-600 dark:text-gray-300 z-10">
                    {item.text}
                  </p>
                </div>

                {/* 🔥 Animated Dot (hidden on small screens) */}
